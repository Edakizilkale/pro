...
int main() {
    ...
    list.countNegative(-5);
    list.countNegative(-1);
    list.countNegative(-3);
    list.countNegative(1);
    
    list.print();
    int x;
    int data;
    x=list.countNegative(data);
    cout<<"Number of Negatives:"<<x;
   return 0;
}
